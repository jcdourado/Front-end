/*
	var
	const, let -> escopo de funcão

	Primitivo(false em comparação) x Boolean object(true)

	throw e throw new

	Promise(resolve, reject) - chama um promise: caso sucesso chama resolve, caso falha chama reject
